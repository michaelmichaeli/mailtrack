    ...
    return (
      <button
        ...
        className={cn(
          ...
          // Variants
          variant === "default" && "bg-gradient-to-r from-primary to-indigo-500 dark:from-primary dark:to-indigo-400 text-primary-foreground shadow-md hover:shadow-lg hover:brightness-110",
