...
const ru: Record<TranslationKey, string> = {
  ...
  "settings.emailDigestDesc": "Получайте сводку о доставках по электронной почте",
  "settings.digestFrequency": "Частота",
  "settings.digestFrequencyDesc": "Как часто получать сводку",
  "settings.frequencyDaily": "Ежедневно",
  "settings.frequencyWeekly": "Еженедельно",
  "settings.frequencyMonthly": "Ежемесячно",
  "settings.frequencyYearly": "Ежегодно",
  ...
  "map.subtitle": "Отслеживайте посылки на интерактивной карте с местоположениями в реальном времени",
  "map.noLocations": "Данные о местоположении ещё недоступны",
  "map.noLocationsHint": "Данные о местоположении появляются когда посылки сканируются в транзитных точках. Попробуйте синхронизировать.",
  ...
  "map.legend": "Легенда",
  "map.legendTitle": "Легенда карты",
  "map.legendDesc": "Каждая точка — последнее известное местоположение посылки. Цвета указывают статус доставки.",
  "map.showing": "Показано",
  "map.activeOnly": "Только активные",
  "map.showAll": "Показать все",
  "map.viewPackage": "Подробности посылки",
  "map.noResults": "Нет посылок по фильтрам",
  "map.adjustFilters": "Попробуйте изменить фильтры статуса выше",
