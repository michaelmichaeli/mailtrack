const en = {
  ...
  "settings.emailDigestDesc": "Get a summary of your deliveries by email",
  "settings.digestFrequency": "Frequency",
  "settings.digestFrequencyDesc": "How often to receive the digest",
  "settings.frequencyDaily": "Daily",
  "settings.frequencyWeekly": "Weekly",
  "settings.frequencyMonthly": "Monthly",
  "settings.frequencyYearly": "Yearly",
  ...
  "map.subtitle": "Track your packages on an interactive map with real-time locations",
  "map.noLocations": "No location data available yet",
  "map.noLocationsHint": "Location data appears when your packages are scanned at transit points. Try syncing your packages.",
  ...
  "map.legendDesc": "Each dot represents a package's last known location. Colors indicate the current delivery status.",
  "map.showing": "Showing",
  "map.activeOnly": "Active only",
  "map.showAll": "Show all",
  "map.viewPackage": "View package details",
  "map.noResults": "No packages match filters",
  "map.adjustFilters": "Try adjusting your status filters above",
